...
function ($rootScope, $scope, $state, $location, Flash, appSettings, $firebaseAuth, $firebaseObject) {
    ...
    vm.menuItems = [
        {
            title: 'Controller', // http://dawntech.brazilsouth.cloudapp.azure.com8010/ui/pages/index.html
            icon: 'tablet',
            state: 'controller'
        },
        {
        ...
        {
            title: 'Firewall', // http://dawntech.brazilsouth.cloudapp.azure.com8010/ui/pages/firewall.html
            icon: 'shield',
            state: 'firewall'
        },
        {
