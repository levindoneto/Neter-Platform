    ...
    'reachabilityController', [
        ...
        function (
            ...
            $scope.verifyReachability = function() {
                ...
                //     swal({
                //         title: 'Are you sure you want to verify reachability of the topology '.concat($scope.currentTopology.fullName, '?'),
                //         showCancelButton: true,
                ...
                //                 if (result) {
                //                     axios.get('http://dawntech.brazilsouth.cloudapp.azure.com:8060/reachability')
