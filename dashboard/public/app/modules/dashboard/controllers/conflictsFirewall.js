        ...
        function (
            ...
            $scope.verifyRulesFirewall = function() {
                swal({
                    ...
                    swal({
                        title: 'Are you sure you want to verify conflicts in the firewalls of the topology '.concat($scope.currentTopology.fullName, '?'),
                        showCancelButton: true,
                        ...
                        preConfirm: function(result) {
                            return new Promise(function(resolve, reject) {
                                if (result) {
                                    axios.get('http://dawntech.brazilsouth.cloudapp.azure.com:8060/rules/firewall/conflicts')
                                    ...
                                    .catch(function(error){
                                        swal({
                                            title: 'Error on verifying conflicts in the firewalls of the topology '.concat($scope.currentTopology.fullName),
