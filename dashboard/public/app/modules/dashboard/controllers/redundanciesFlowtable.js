dashboard.controller(
    'redundanciesFlowtableController', [
        '$scope',
        '$firebaseObject',
        '$firebaseArray',
        '$rootScope',
        ...
        function (
            ...
            const verifications = firebase.database().ref(`/users/${$scope.userId}/verifications/flowtable/redundancies`);
                            ...
                            return new Promise(function(resolve, reject) {
                                if (result) {
                                    ...
                                    .catch(function(error){
                                        swal({
                                            title: 'Error on verifying redundancies in the flowtables of the topology '.concat($scope.currentTopology.fullName),
