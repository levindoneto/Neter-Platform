...
The port that floodlight is set to run within this project is **8010**, so the web gui can be accessed from [dawntech.brazilsouth.cloudapp.azure.com:8010/ui/pages/index.html](dawntech.brazilsouth.cloudapp.azure.com:8010/ui/pages/index.html).
