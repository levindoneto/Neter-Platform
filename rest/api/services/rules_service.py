...
def verifyFlowtable(ip, port):
    ...
    for s in lista_switches:
        ...
        for rule_index in range(len(json_data)):
            ...
            if json_data[rule_index].has_key('instructions') == True:
                if json_data[rule_index]['instructions'].has_key('actions') == True:
                    lista_actions.append(str(json_data[rule_index]['instructions']['instruction_apply_actions']['actions']))
                else:
                    lista_actions.append("x")

            if json_data[rule_index].has_key('actions') == True:
                if json_data[rule_index]['actions'].has_key('actions') == True:
                    lista_actions.append(str(json_data[rule_index]['actions']['actions']))
                else:
                    lista_actions.append("x")
    ...
    return [fileId, time_end-time_init, n_flows, memory_kilobytes]

"""
Get conflicts within flowtable.
"""
def getConflictsFlowtable(verificationId, time_elapsed, n_flows, memory_kilobytes):
...
"""
def getRedundanciesFlowtable(verificationId, time_elapsed, n_flows, memory_kilobytes):
